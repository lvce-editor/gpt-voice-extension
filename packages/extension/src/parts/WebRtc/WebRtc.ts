...
const viewportToolInstructions =
  ' Use get_visible_editor_lines when the user asks which lines are currently visible. Use scroll_editor when the user asks to scroll the active editor up or down. To scroll to named code, first locate its line with the workspace tools, then use set_editor_selections to reveal it.'
