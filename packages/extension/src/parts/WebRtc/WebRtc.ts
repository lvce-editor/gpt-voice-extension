...
export const createSessionConfig = (
  ...
  return {
    session: {
      ...
      instructions:
        'Use open_html_preview whenever the user asks to show, open, or preview an HTML page in the editor preview area. After creating or modifying code that runs in the preview, refresh or open the preview, call get_preview_runtime_diagnostics, and fix any reported runtime errors before finishing. ' +
