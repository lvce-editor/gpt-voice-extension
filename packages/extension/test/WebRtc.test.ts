...
test('createSessionConfig - provides developer vocabulary to transcription', () => {
  ...
  expect(config.session.audio.input.transcription.prompt).toBe(
    'English speech about software development. Use the Latin alphabet and English spelling. Common terms and spellings: API, CLI, CI (pronounced "see eye"; continuous integration), Git, GitHub, npm, Node.js, TypeScript, JavaScript, README (pronounced "read me"), VS Code, LVCE Editor, quick pick.',
  )
})
